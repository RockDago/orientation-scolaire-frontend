...
export default function ParcoursView() {
  ...
  // ── Chargement initial : parcours + mentions en parallèle ──────────
  useEffect(() => {
  ...
  return (
    <div className="p-6 bg-white rounded-2xl shadow-sm border border-gray-100">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500">Gérez les parcours de formation disponibles</p>
      </div>
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="border-b border-gray-200 bg-gray-50">
                ...
                <th className="px-6 py-3 text-sm font-semibold text-gray-700">Durée</th>
            ...
            <tbody>
              {parcours.map((p) => (
                ...
                >
                  ...
                  <td
                    className="px-6 py-4 font-medium text-gray-900 cursor-pointer hover:text-blue-600 transition-colors"
                    onClick={() => setSelectedParcours(p)}
      ...
      {!loading && parcours.length > 0 && (
        <div className="mt-4 text-xs text-gray-400 text-right">
          {parcours.length} parcours trouvé{parcours.length > 1 ? "s" : ""}
        </div>
      )}
          ...
          <div className="bg-white rounded-2xl p-6 max-w-lg w-full mx-4">
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                {/* Niveau — déclenche la synchro durée */}
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Niveau
                  </label>
                ...
                {/* Durée — remplie automatiquement, lecture seule */}
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Durée
                    {formData.niveau && (
                  ...
                  <select
                    ...
                    className={`w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white ${
                      formData.niveau !== ""
                        ? "bg-gray-50 text-blue-600 font-semibold cursor-not-allowed"
                        : ""
                    }`}
                  >
                    <option value="">Sélectionner</option>
              ...
              {formData.niveau && (
                <div className="flex items-center gap-2 px-3 py-2 bg-blue-50 rounded-lg border border-blue-100">
                  ...
                  <p className="text-xs text-blue-600">
                    <span className="font-semibold">{formData.niveau}</span> →{" "}
                    durée automatiquement définie à{" "}
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl p-6 max-w-lg w-full mx-4">
            ...
            <div className="flex gap-3">
              <button
                onClick={() => setSelectedParcours(null)}
                className="flex-1 px-4 py-2 rounded-lg bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold transition-colors"
              >
                Fermer
              </button>
              <button
                ...
                className="flex-1 px-4 py-2 rounded-lg bg-blue-100 hover:bg-blue-200 text-blue-700 font-semibold transition-colors"
              >
                Modifier
              </button>
            </div>
