...
const Navbar = ({ collapsed, user, onMobileMenuClick }) => {
  ...
  const openProfileMenu = () => {
    if (closeProfileTimerRef.current) {
      clearTimeout(closeProfileTimerRef.current);
      closeProfileTimerRef.current = null;
    }
  ...
  const closeProfileMenu = () => {
    closeProfileTimerRef.current = setTimeout(() => {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex items-center space-x-3 md:space-x-6">
          ...
          >
            ...
            {showProfileMenu && (
              <div
                className="absolute right-0 top-12 w-64 bg-white dark:bg-neutral-900 rounded-xl shadow-xl border border-gray-100 dark:border-neutral-800 z-50 overflow-hidden py-2"
                onMouseEnter={openProfileMenu}
                onMouseLeave={closeProfileMenu}
                role="menu"
              >
      ...
      {showLogoutModal && (
        ...
        >
          <div
            className="bg-white dark:bg-neutral-900 rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden animate-in zoom-in-95 duration-200 border border-transparent dark:border-neutral-800"
